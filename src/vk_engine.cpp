...
void VulkanEngine::draw_objects(VkCommandBuffer cmd, RenderObject *first, int count)
{
  ...
  // camera view
  glm::vec3 camPos = {1.f, 6.f, 10.f};

  // glm::vec3 bro = {_selectedShader, _selectedShader, _selectedShader};
...
void VulkanEngine::load_meshes()
{
  ...
  triMesh._vertices[0].position = {1000.f, 1.f, 0.5f};
  triMesh._vertices[1].position = {10000.f, 1.f, 0.5f};
  triMesh._vertices[2].position = {10000.f, -1.f, 0.5f};
  ...
  Mesh load_mesh{};
  load_mesh.load_from_obj("assets/monkey_flat.obj");

  upload_mesh(triMesh);
  upload_mesh(load_mesh);
...
void VulkanEngine::init_scene()
{
  ...
  monkey.transformMatrix = glm::mat4{-11.0f};
